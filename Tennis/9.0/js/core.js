...
function core (pn,loop){
	...
	if (pn == 0) {
		...
		$('#p3ui').velocity({rotateY:0,translateX:0,translateZ:0,rotateX:0,opacity:1},{duration:2000,easeing:'ease'})
		$('#title3').velocity({rotateY:0,translateZ:0,rotateX:0},{duration:2000,easeing:'ease'})
		$('#title3_1').velocity({opacity:1},{duration:600,easeing:'ease',delay:1800})
		// p1 away
		var p1away = function(){
			$('#stage2').velocity({translateZ:'2000px'},{duration:2000,easing:'ease'})
